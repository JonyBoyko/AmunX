...
enum NavTab { feed, circle, search, notifications, profile }
        ...
        child: Padding(
          ...
          child: Row(
            ...
            children: [
              ...
              _NavItem(icon: Icons.person_rounded, label: 'Профіль', isActive: activeTab == NavTab.profile, onTap: () => onTabSelected(NavTab.profile)),
            ],
          ),
        ),
      ),
