	...
	cards := []ExploreCardResponse{
		{
			...
			Owner: UserResponse{
				...
				AvatarURL:   "https://cdn.amunx.com/avatars/jane.jpg",
			},
			DurationSec:     45,
			PreviewSentence: "A quick tip about React hooks",
			Tags:            []string{"react", "javascript"},
			AudioURL:        "https://cdn.amunx.com/audio/sample1.mp3",
		...
		},
		{
			...
			Owner: UserResponse{
				...
				AvatarURL:   "https://cdn.amunx.com/avatars/john.jpg",
			},
			DurationSec: 15,
			Title:       "Best Quote",
			Quote:       "Ship it!",
			AudioURL:    "https://cdn.amunx.com/audio/clip1.mp3",
